---
description: Examples give users step by step instructions on how to complete a concrete task.
...
Examples are analogous to [how-tos in Diataxis](https://diataxis.fr/explanation/). You should use this folder to give in depth guides on how to complete concrete single tasks. For example:
...
Example file should be **action oriented**. This means that you should first think of what you want the user to achieve
with this example, and explain only that. You may shortly introduce a [key concept](../key_concepts/README.md) and add 
...
Your examples will probably be related to one or more key concepts, tutorials, or even examples. Please make sure 
